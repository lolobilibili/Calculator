...
public:
    ...
    void setupUi(QMainWindow *Notepad)
    {
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/images/images/paste.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/images/images/bold.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionBold->setIcon(icon13);
        actionUnderline = new QAction(Notepad);
        actionUnderline->setObjectName("actionUnderline");
        actionUnderline->setCheckable(true);
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/images/images/underline.png"), QSize(), QIcon::Normal, QIcon::Off);
